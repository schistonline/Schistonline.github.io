...
const ProductDetail = {
    ...
    // Contact Supplier - Goes to supplier-contact.html
    contactSupplier() {
        const params = new URLSearchParams();
        params.append('product_id', this.productId);
        params.append('quantity', this.selectedQuantity);
        
        if (this.currentVariant && this.currentVariant.color_name !== 'Default') {
    ...
    // Send Inquiry - Goes to product-inquiry.html
    sendInquiry() {
        const params = new URLSearchParams();
        params.append('product_id', this.productId);
        params.append('quantity', this.selectedQuantity);
    ...
    setupEventListeners() {
        ...
        // Send Inquiry - goes to product-inquiry.html
        document.getElementById('quickInquiryBtn')?.addEventListener('click', () => this.sendInquiry());
        document.getElementById('floatingQuickInquiry')?.addEventListener('click', () => this.sendInquiry());
